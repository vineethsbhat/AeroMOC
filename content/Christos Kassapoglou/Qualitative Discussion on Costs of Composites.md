...
>The most common efficient process developed is filament winding, pultrusion and compression moulding. 

[[Filament Winding Process]]

>Pultrusion is a process where fibres are pulled through a resin bath and then through a heated die that gives the final shape.

>Press molding solves the issue of out of plane stress. Instead of using neat, flat sheets of fabric, press moulding uses a **"slurry" of chips.**  Imagine taking those sheets of fabric and putting them through a paper shredder until you have a bucket full of "confetti" or chips. These chips are long, discontinuous fibers mixed with resin. You pour this thick mixture into a mold and apply high pressure. Because the mixture is a random jumble (like a bowl of spaghetti rather than a stack of lasagna), the fibers end up pointing in **every direction**. Press moulding is the "Goldilocks" solution. It isn't as incredibly strong as stitching the layers together, but it is much stronger than just gluing layers, and it is very cheap to manufacture.


### There is one more aspect that should be mentioned briefly ;
...
> An 85% learning curve means that the cost of unit 2n is 85% of the cost of unit n

==It means that every time your total production **doubles**, your cost per unit drops to **85%** of what it was before.==

Therefore, while the conclusion that a less-automated process will give lower average cost over a sufficiently large production run is valid, in reality, it may only occur under very special circumstances favouring continuous process improvement, consistent high part quality and part accuracy. Thus, despite this, automated processes are preferred because of their quality, consistency and potential for continuous improvement. 



2. Non Recurring : These are divided into stages and follow the phase of the development program of the structure/component.
...
e. Certification : The most expensive process